...
"./Button":()=>{
      ...
      return __federation_import('/ubiquitous-giggle/remote/assets/__federation_expose_Button-PHwv8R8-.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
      const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
        ...
        const base = '/ubiquitous-giggle/remote/';
        'assets';
