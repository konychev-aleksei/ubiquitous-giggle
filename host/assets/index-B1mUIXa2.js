...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-CJ2OfFKA.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-CdfCqs9i.js', import.meta.url).href),import:true}};
...
'remote':{url:'https://konychev-aleksei.github.io/ubiquitous-giggle/remote/assets/remoteEntry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.1.0':{get:()=>get(new URL('__federation_shared_react-CJ2OfFKA.js', import.meta.url).href), loaded:1}},'react-dom':{'19.1.0':{get:()=>get(new URL('__federation_shared_react-dom-CdfCqs9i.js', import.meta.url).href), loaded:1}}
...
const RemoteButton = lazy(() => __federation_method_getRemote("remote" , "./Button").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
